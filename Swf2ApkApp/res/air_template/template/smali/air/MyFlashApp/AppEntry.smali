.class public Lair/{{ProjectName}}/AppEntry;
...
.field private static final RESOURCE_CLASS:Ljava/lang/String; = "air.{{ProjectName}}.R"
...
.field private static sThis:Lair/{{ProjectName}}/AppEntry;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lair/{{ProjectName}}/AppEntry;->sRuntimeClassesLoaded:Z

    .line 62
    sput-object v1, Lair/{{ProjectName}}/AppEntry;->sAndroidActivityWrapper:Ljava/lang/Object;

    .line 63
    sput-object v1, Lair/{{ProjectName}}/AppEntry;->sThis:Lair/{{ProjectName}}/AppEntry;

    .line 64
    const-string v0, "com.adobe.air"

    sput-object v0, Lair/{{ProjectName}}/AppEntry;->RUNTIME_PACKAGE_ID:Ljava/lang/String;

    .line 65
    const-string v0, "https://airdownload2.adobe.com/air?"

    sput-object v0, Lair/{{ProjectName}}/AppEntry;->AIR_PING_URL:Ljava/lang/String;
...
.method private BroadcastIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lair/{{ProjectName}}/AppEntry;->startActivity(Landroid/content/Intent;)V
    :try_end_0
...
.method private varargs InvokeMethod(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .prologue
    .line 358
    sget-boolean v1, Lair/{{ProjectName}}/AppEntry;->sRuntimeClassesLoaded:Z
    ...
    .line 365
    :try_start_0
    sget-object v1, Lair/{{ProjectName}}/AppEntry;->sAndroidActivityWrapper:Ljava/lang/Object;
...
.method private InvokeWrapperOnCreate()V
    ...
    .line 336
    :try_start_0
    sget-object v7, Lair/{{ProjectName}}/AppEntry;->sAndroidActivityWrapperClass:Ljava/lang/Class;
    ...
    invoke-direct {p0, v4, v7}, Lair/{{ProjectName}}/AppEntry;->InvokeMethod(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method static synthetic access$000(Lair/{{ProjectName}}/AppEntry;)V
    .locals 0
    .param p0, "x0"    # Lair/{{ProjectName}}/AppEntry;

    .prologue
    .line 56
    invoke-direct {p0}, Lair/{{ProjectName}}/AppEntry;->launchMarketPlaceForAIR()V

    return-void
.end method

.method static synthetic access$100()Lair/{{ProjectName}}/AppEntry;
    .locals 1

    .prologue
    .line 56
    sget-object v0, Lair/{{ProjectName}}/AppEntry;->sThis:Lair/{{ProjectName}}/AppEntry;
...
.method static synthetic access$200()Ljava/lang/String;
    ...
    .prologue
    .line 56
    sget-object v0, Lair/{{ProjectName}}/AppEntry;->AIR_PING_URL:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic access$300(Lair/{{ProjectName}}/AppEntry;)V
    .locals 0
    .param p0, "x0"    # Lair/{{ProjectName}}/AppEntry;

    .prologue
    .line 56
    invoke-direct {p0}, Lair/{{ProjectName}}/AppEntry;->loadSharedRuntimeDex()V

    return-void
.end method

.method static synthetic access$400(Lair/{{ProjectName}}/AppEntry;Z)V
    .locals 0
    .param p0, "x0"    # Lair/{{ProjectName}}/AppEntry;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 56
    invoke-direct {p0, p1}, Lair/{{ProjectName}}/AppEntry;->createActivityWrapper(Z)V
...
.method static synthetic access$500()Z
    ...
    .prologue
    .line 56
    sget-boolean v0, Lair/{{ProjectName}}/AppEntry;->sRuntimeClassesLoaded:Z

    return v0
.end method

.method static synthetic access$600(Lair/{{ProjectName}}/AppEntry;)V
    .locals 0
    .param p0, "x0"    # Lair/{{ProjectName}}/AppEntry;

    .prologue
    .line 56
    invoke-direct {p0}, Lair/{{ProjectName}}/AppEntry;->InvokeWrapperOnCreate()V
...
.method static synthetic access$700()V
    ...
    .prologue
    .line 56
    invoke-static {}, Lair/{{ProjectName}}/AppEntry;->KillSelf()V
...
.method private createActivityWrapper(Z)V
    ...
    .line 629
    :try_start_0
    sget-object v1, Lair/{{ProjectName}}/AppEntry;->sAndroidActivityWrapperClass:Ljava/lang/Class;
...
.method private isRuntimeInstalled()Z
    ...
    .prologue
    .line 123
    invoke-virtual {p0}, Lair/{{ProjectName}}/AppEntry;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    :try_start_0
    sget-object v2, Lair/{{ProjectName}}/AppEntry;->RUNTIME_PACKAGE_ID:Ljava/lang/String;
...
.method private launchAIRService()V
    ...
    .line 292
    new-instance v0, Lair/{{ProjectName}}/AppEntry$3;

    invoke-direct {v0, p0}, Lair/{{ProjectName}}/AppEntry$3;-><init>(Lair/{{ProjectName}}/AppEntry;)V

    .line 323
    .local v0, "conn":Landroid/content/ServiceConnection;
    const/4 v2, 0x1

    invoke-virtual {p0, v1, v0, v2}, Lair/{{ProjectName}}/AppEntry;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private launchMarketPlaceForAIR()V
    ...
    invoke-virtual {p0}, Lair/{{ProjectName}}/AppEntry;->getComponentName()Landroid/content/ComponentName;
    ...
    sget-object v6, Lair/{{ProjectName}}/AppEntry;->RUNTIME_PACKAGE_ID:Ljava/lang/String;
    ...
    invoke-direct {p0, v5, v3}, Lair/{{ProjectName}}/AppEntry;->BroadcastIntent(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
...
.method private loadCaptiveRuntimeClasses()Z
    ...
    sput-object v1, Lair/{{ProjectName}}/AppEntry;->sAndroidActivityWrapperClass:Ljava/lang/Class;
    ...
    sput-boolean v1, Lair/{{ProjectName}}/AppEntry;->sRuntimeClassesLoaded:Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private loadSharedRuntimeDex()V
    ...
    .line 605
    sget-object v1, Lair/{{ProjectName}}/AppEntry;->RUNTIME_PACKAGE_ID:Ljava/lang/String;

    const/4 v2, 0x3

    invoke-virtual {p0, v1, v2}, Lair/{{ProjectName}}/AppEntry;->createPackageContext(Ljava/lang/String;I)Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lair/{{ProjectName}}/AppEntry;->getFilesDir()Ljava/io/File;
    ...
    sput-object v1, Lair/{{ProjectName}}/AppEntry;->sDloader:Ldalvik/system/DexClassLoader;

    .line 611
    sget-object v1, Lair/{{ProjectName}}/AppEntry;->sDloader:Ldalvik/system/DexClassLoader;
...
.method private registerForNotifications()V
    ...
    .line 279
    invoke-virtual {p0, v0}, Lair/{{ProjectName}}/AppEntry;->startService(Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method private showDialog(ILjava/lang/String;II)V
    ...
    .line 163
    new-instance v1, Lair/{{ProjectName}}/AppEntry$1;

    invoke-direct {v1, p0}, Lair/{{ProjectName}}/AppEntry$1;-><init>(Lair/{{ProjectName}}/AppEntry;)V
    ...
    .line 179
    new-instance v1, Lair/{{ProjectName}}/AppEntry$2;

    invoke-direct {v1, p0}, Lair/{{ProjectName}}/AppEntry$2;-><init>(Lair/{{ProjectName}}/AppEntry;)V
...
.method private showRuntimeNotInstalledDialog()V
    ...
    const-string v2, "air.{{ProjectName}}.R"
    ...
    invoke-virtual {p0, v3}, Lair/{{ProjectName}}/AppEntry;->getString(I)Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v1, v3, v4}, Lair/{{ProjectName}}/AppEntry;->showDialog(ILjava/lang/String;II)V
...
.method public dispatchGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    .local v0, "handled":Z
    :try_start_0
    sget-object v4, Lair/{{ProjectName}}/AppEntry;->sAndroidActivityWrapperClass:Ljava/lang/Class;
    ...
    invoke-direct {p0, v1, v4}, Lair/{{ProjectName}}/AppEntry;->InvokeMethod(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public finishActivityFromChild(Landroid/app/Activity;I)V
    ...
    invoke-direct {p0, v0, v1}, Lair/{{ProjectName}}/AppEntry;->InvokeMethod(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    .local v2, "retval":Z
    :try_start_0
    sget-object v3, Lair/{{ProjectName}}/AppEntry;->sAndroidActivityWrapperClass:Ljava/lang/Class;
    ...
    invoke-direct {p0, v1, v3}, Lair/{{ProjectName}}/AppEntry;->InvokeMethod(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 219
    sput-object p0, Lair/{{ProjectName}}/AppEntry;->sThis:Lair/{{ProjectName}}/AppEntry;
    ...
    .line 230
    invoke-direct {p0}, Lair/{{ProjectName}}/AppEntry;->loadCaptiveRuntimeClasses()Z
    ...
    .line 233
    sget-boolean v4, Lair/{{ProjectName}}/AppEntry;->sRuntimeClassesLoaded:Z

    if-nez v4, :cond_1

    invoke-direct {p0}, Lair/{{ProjectName}}/AppEntry;->isRuntimeInstalled()Z
    ...
    .line 238
    invoke-direct {p0}, Lair/{{ProjectName}}/AppEntry;->isRuntimeOnExternalStorage()Z
    ...
    .line 239
    invoke-direct {p0}, Lair/{{ProjectName}}/AppEntry;->showRuntimeOnExternalStorageDialog()V
    ...
    .line 241
    :cond_0
    invoke-direct {p0}, Lair/{{ProjectName}}/AppEntry;->showRuntimeNotInstalledDialog()V
    ...
    .line 249
    invoke-direct {p0, v0}, Lair/{{ProjectName}}/AppEntry;->createActivityWrapper(Z)V
    ...
    .line 268
    :cond_4
    invoke-direct {p0}, Lair/{{ProjectName}}/AppEntry;->launchAIRService()V
...
.method protected onNewIntent(Landroid/content/Intent;)V
    ...
    .line 570
    :try_start_0
    sget-object v2, Lair/{{ProjectName}}/AppEntry;->sAndroidActivityWrapperClass:Ljava/lang/Class;
    ...
    invoke-direct {p0, v1, v2}, Lair/{{ProjectName}}/AppEntry;->InvokeMethod(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
